...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    //Vamos hacer una vatria global
    int num_cliente;
     Mascota masco;
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ModificarDatos.class.getName());

    //Modificamos el constructor para que reciba el num del cliente, así pueda saber cual editar
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //Instanciamos la clase de VerDatos
        VerDatos pantalla = new VerDatos();
        //
        pantalla.setVisible(true);
        pantalla.setLocationRelativeTo(null);
        //Para que se cierre la ventana una vez se apliquen los cambios
        this.dispose();
    ...
    private void cargarDatos(int num_cliente) {
        ...
        //Asignamos a todos los datos de la parte de la controladora grafica
        txtNombre.setText(masco.getNombre());
        txtRaza.setText(masco.getRaza());
        txtColor.setText(masco.getColor());
        txtObservaciones.setText(masco.getObservaciones());
        //Este va doble, porque unDuenio nos trae todo el objeto duenio
        txtNomDuenio.setText(masco.getUnDuenio().getNombre());
        txtCelDuenio.setText(masco.getUnDuenio().getCelDuenio());
        
        //Hacemos un if, ya que es un combo box, entones las opciones vienen en un arreglo
